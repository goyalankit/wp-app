...
\begin{SCfigure}
  ...
  \includegraphics[width=0.5\textwidth]%
    {powerconsumption1.png}% picture filename
...
\begin{SCfigure}
  \centering
  \includegraphics[width=0.5\textwidth]%
    {powerconsumption2.png}% picture filename
...
\begin{SCfigure}
  \centering
  \includegraphics[width=0.5\textwidth]%
    {cellular_withoutheaders.png}% picture filename
...
\begin{SCfigure}
  \centering
  \includegraphics[width=0.5\textwidth]%
    {cellular_withheaders.png}% picture filename
...
\begin{SCfigure}
  \centering
  \includegraphics[width=0.5\textwidth]%
    {wifi_withoutheaders.png}% picture filename
...
\begin{SCfigure}
  \centering
  \includegraphics[width=0.5\textwidth]%
    {wifi_withheaders.png}% picture filename
